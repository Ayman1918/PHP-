    ...
    <div class="container-scroller">
      ...
      <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
          <a class="navbar-brand brand-logo" href="index.html">HMS</a>
            ...
            <li class="nav-item nav-profile dropdown">
              <a class="nav-link dropdown-toggle" id="profileDropdown" href="#" data-toggle="dropdown" aria-expanded="false">
                <div class="nav-profile-img">
                  ...
                  <span class="availability-status online"> <?php echo $_SESSION['AD_NAME']   ?></span>
                </div>
              ...
              <div class="dropdown-menu navbar-dropdown" aria-labelledby="profileDropdown">
                <a class="dropdown-item" href="View_AdminProfile.php">
                  <i class="mdi mdi-cached mr-2 text-success"></i> View Profile </a>
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          <ul class="nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="Viewall_City.php">
                <span class="menu-title">View All City</span>
            ...
            <li class="nav-item">
              <a class="nav-link" href="view_doctor.php">
                <span class="menu-title">View All Doctor</span>
                <i class="mdi mdi-format-list-bulleted menu-icon"></i>
              </a>
            </li>
            <li class="nav-item">
              ...
              <a class="nav-link" href="view_patient.php">
                <span class="menu-title">View All Patients</span>
                <i class="mdi mdi-format-list-bulleted menu-icon"></i>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="Add_appointment.php">
                <span class="menu-title">Add Appoinments</span>
                <i class="mdi mdi-format-list-bulleted menu-icon"></i>
              </a>
            </li>
          <li class="nav-item">
              <a class="nav-link" href="view_appointment.php">
                <span class="menu-title">View Appoinments</span>
                <i class="mdi mdi-format-list-bulleted menu-icon"></i>
              </a>
            </li>
            <li class="nav-item">
